...
Run a basic availability check for core routes and API:

```powershell
pwsh ./bin/smoke_check.ps1
```

You can also pass a different base URL:

```powershell
pwsh ./bin/smoke_check.ps1 -BaseUrl http://localhost:5000
```
